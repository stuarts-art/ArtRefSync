...
class CanvasImage:
    ...
    def set_image(self, path):
        ...
        if not self.container:
            self.container = self.canvas.create_rectangle((0, 0, self.imwidth*self.imscale, int(self.imheight*self.imscale)), width=0)
        else:
            self.canvas.coords(self.container, (0, 0, self.imwidth*self.imscale, int(self.imheight*self.imscale)))
